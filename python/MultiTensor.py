...
class MultiTensor :
    ...
    def output_results(self,maxL,nodes):
        ...
        in1=open(infile1,'w')
        in3=open(infile3,'w')
        print("# Max Likelihood= ",maxL," N_real=",self.N_real,file=in1)
        print("# Max Likelihood= ",maxL," N_real=",self.N_real, file=in3)
        if(self.undirected==False):
        ...
        for l in range(self.L):
            if(self.assortative==False):
                ...
                print(l, file=in3)
                for k in range(self.K):	print(self.w_f[k][l], file=in3)
                print(file=in3)
        in3.close();
