...
if(MULTI_TENSOR_PYTHON_EXTENSIONS)
    ...
    set(MULTI_TENSOR_PYTHON_PACKAGE_ROOT ${MULTI_TENSOR_PYTHON_ROOT}/package)

    # either generate the .cpp from the .pyx file is Cython exists, or copy the .cpp from the repo
    ...
    if(CYTHON_PROGRAM)
        add_custom_command(
            ...
            ARGS
                --cplus -3
                "${MULTI_TENSOR_PYTHON_PACKAGE_ROOT}/multitensor.pyx"
                -o
                ${_cython_generated_file}
            COMMENT
        ...
        configure_file(
            ${MULTI_TENSOR_PYTHON_PACKAGE_ROOT}/multitensor.cpp
            ${_cython_generated_file}
            COPYONLY)
    endif()
    ...
    add_custom_target(
        cython_pyx_file
        SOURCES "${MULTI_TENSOR_PYTHON_PACKAGE_ROOT}/multitensor.pyx")
    ...
    set(_setup_py_in ${MULTI_TENSOR_PYTHON_ROOT}/setup.py)
    ...
    add_custom_command(
      ...
      COMMAND ${Python3_EXECUTABLE} ${MULTI_TENSOR_PYTHON_ROOT}/update_setup.py setup.py
